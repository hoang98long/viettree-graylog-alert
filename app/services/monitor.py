...
class MonitorService:
    ...
    def status(self) -> dict:
        ...
        return {"graylog": self.graylog_status, "telegram": "configured" if self.telegram.configured else "not configured", "asa_ip": self.settings.asa_ip, "poll_interval": self.settings.poll_interval_seconds, "last_poll": self.last_poll.isoformat() if self.last_poll else None, "events_today": count}
